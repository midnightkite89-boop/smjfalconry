    ...
    <div class="page-inner">
      ...
      <section class="main-content">
        <div class="container">
          ...
          <!-- /\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/ -->          
          <?php include($_SERVER['DOCUMENT_ROOT'].'/site-files/includes/blog-posts/example-youtube-2.php') ;?>

          <?php include($_SERVER['DOCUMENT_ROOT'].'/site-files/includes/blog-posts/example-youtube-1.php') ;?>
