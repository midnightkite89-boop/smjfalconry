<?php
    ...
    $OGType = 'website';
    $PageTitle = "Sorry Transation Failed | SMJ Falconry";
    $PageDescr = "";
...
<body>
    ...
    <div itemscope itemtype="http://schema.org/BreadcrumbList">
        ...
        <div itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem">
		  ...
		  <meta itemprop="name" content="Purchase Transaction Failed">
          ...
          <div class="transction-page">
            <div class="shaded-container">
              <div class="row">
                ...
                <div class="col-sm-7">
                  <h1>Sorry, your order was not completed!</h1>
                  <h2>If you are having trouble ordering, please feel free to</h2>
